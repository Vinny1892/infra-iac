...
resource "aws_security_group" "k3s_sg" {
  ...
  # Traefik HTTP (NLB from LB Controller)
  ingress {
    from_port   = 80
    to_port     = 80
    protocol    = "tcp"
  ...
  # Traefik HTTPS (NLB from LB Controller)
  ingress {
    from_port   = 443
    to_port     = 443
    protocol    = "tcp"
  ...
  # NodePort range (NLB health checks)
  ingress {
    from_port   = 30000
    to_port     = 32767
    protocol    = "tcp"
...
# =============================================================================
# IAM - Node Role (SSM + SSM Parameter + S3 OIDC upload)
# =============================================================================
