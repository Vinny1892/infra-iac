...
module task {
  ...
  task_name = "loki-production"
  enable_efs = true
  enable_cloud_watch = true
  cloud_watch_configuration = {
    logName = "/org/principia/loki-production"
    region = "us-east-1"
  }
